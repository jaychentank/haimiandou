...
class BaseOptions():
    ...
    def initialize(self):
        # self.parser.add_argument('--dataroot', required=True, type=str,default = './data',help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--depthSize', type=int, default=64, help='depth for 3d images')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='unet_64',
        ...
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for GPU')
        self.parser.add_argument('--name', type=str, default='experiment_name',
                                 help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--dataset_mode', type=str, default='nodule',
                                 help='chooses how datasets are loaded. [unaligned | aligned | single | nodule | test]')
        self.parser.add_argument('--model', type=str, default='pix2pix3d',
                                 help='chooses which model to use. cycle_gan, pix2pix, pix2pix3d, test')
